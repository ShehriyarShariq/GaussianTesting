...
function App() {
  ...
  useEffect(() => {
    ...
    renderer.current.domElement.addEventListener('dragenter', onAnimInterrupt)
    renderer.current.domElement.addEventListener('contextmenu', onAnimInterrupt)

    renderer.current.domElement.addEventListener('mousedown', onAnimInterrupt)
    renderer.current.domElement.addEventListener('wheel', onAnimInterrupt)

    renderer.current.domElement.addEventListener('touchstart', onAnimInterrupt)
    ...
    return () => {
      ...
      renderer.current.domElement.removeEventListener('wheel', onAnimInterrupt)
  ...
  //     </div>
  //     <div
  //       ref={(el) => (el ? el.appendChild(renderer.current.domElement) : null)}
  //     />
  //   </div>
  // )
  ...
  //   new SPLAT.OrbitControls(camera.current, renderer.current.domElement),
  // )
