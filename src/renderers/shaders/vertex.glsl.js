...
void main () {
    uvec4 cen = texelFetch(u_texture, ivec2((uint(1) & 0x3ffu) << 1, uint(1) >> 10), 0);
    ...
    uvec4 cov = texelFetch(u_texture, ivec2(((uint(1) & 0x3ffu) << 1) | 1u, uint(1) >> 10), 0);
    ...
    gl_Position = vec4(
        vCenter 
        + aPosition.x * majorAxis * scalingFactor / viewport 
        + aPosition.y * minorAxis * scalingFactor / viewport, 0.0, 1.0);
}
`
